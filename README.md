...
- 🎯 Entry points to execute your program using `python -m <wfc>` or `$ wfc` with basic CLI argument parsing.
...
Awesome wfc created by Ailianlian
...
```py
from wfc import BaseClass
from wfc import base_function
